...
<div style="height: auto;
    ...
    <div style="padding: 10px;padding-bottom: 0px;">
        ...
        <div style="text-align: center;
            ...
            Copyright &copy;${.now?string("yyyy")} <a hover="color: #DA251D;" style="color: #999;" href="https://github.com/elunez/RS" target="_blank">EL-ADMIN</a> 后台管理系统 All Rights Reserved.
        </div>
